...
| Doc | Contents |
|---|---|
| [`docs/techBuilder-Web-Pivot-Plan.md`](docs/techBuilder-Web-Pivot-Plan.md) ⭐ | **THE PIVOT RECORD — ALL PHASES 0–5 ✅ COMPLETE (2026-07-03).** Frontend pivot Android/Expo → Next.js web: scaffold+httpOnly auth, RBAC nav+matrix, all 7 pilot screens, backend hardening, Hindi-first i18n+PWA+Lighthouse-91. Only Sentry remains (needs user DSNs). Read this + the pivot banner in §1 before anything else. |
