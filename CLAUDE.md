...
| [`docs/perf/techBuilder-AWS-Testing-Setup-Plan.md`](docs/perf/techBuilder-AWS-Testing-Setup-Plan.md) 🐢 | **PLANNING ONLY, not built.** Sized AWS dev/testing setup (RDS Mumbai + optional EC2, start/stop usage, ~$7–9/mo) considered as a fix for the above — new-account $200/6mo credit model, staged rollout, cost math, safety habits. Revisit before onboarding the first merchant. |
